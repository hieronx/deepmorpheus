...
if __name__ == '__main__':
    ...
    parser.add_argument('--learning-rate', type=float, default=1e-3) # TODO: use auto-lr finder
    parser.add_argument('--word-embedding-dim', type=int, default=100)
    parser.add_argument('--word-lstm-hidden-dim', type=int, default=100) # TODO: try 100
    ...
    parser.add_argument('--char-lstm-hidden-dim', type=int, default=100) # TODO: try 100
